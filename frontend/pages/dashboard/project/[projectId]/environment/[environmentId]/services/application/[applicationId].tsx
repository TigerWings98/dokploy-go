...
const Service = () => {
	...
	const { projectId, environmentId, applicationId } = router.query as { projectId: string; environmentId: string; applicationId: string };
	const activeTab = (router.query.tab || "general") as TabState;
