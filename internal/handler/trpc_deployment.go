// Input: procedureRegistry, db (Deployment 表)
// Output: registerDeploymentTRPC - Deployment 领域的 tRPC procedure 注册
// Role: Deployment tRPC 路由注册，将 deployment.* procedure 绑定到部署记录查询操作
